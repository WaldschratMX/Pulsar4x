...
namespace Pulsar4X.ECSLib.Factories
{
    ...
    public static class GalaxyFactory
    {
        ...
        // Also note that thile these are GameSettings they were not added to the 
        // GameSettings file because they are only used for star gen.
        ...
        public static Dictionary<SpectralType, MinMaxStruct> StarRadiusBySpectralType = new Dictionary<SpectralType, MinMaxStruct>()
            {
                { SpectralType.O, new MinMaxStruct() { Min = 6.6 * GameSettings.Units.SolarRadiusInAu, Max = 250 * GameSettings.Units.SolarRadiusInAu } },
                { SpectralType.B, new MinMaxStruct() { Min = 1.8 * GameSettings.Units.SolarRadiusInAu, Max = 6.6 * GameSettings.Units.SolarRadiusInAu } },
                { SpectralType.A, new MinMaxStruct() { Min = 1.4 * GameSettings.Units.SolarRadiusInAu, Max = 1.8 * GameSettings.Units.SolarRadiusInAu } },
                { SpectralType.F, new MinMaxStruct() { Min = 1.15 * GameSettings.Units.SolarRadiusInAu, Max = 1.4 * GameSettings.Units.SolarRadiusInAu } },
                { SpectralType.G, new MinMaxStruct() { Min = 0.96 * GameSettings.Units.SolarRadiusInAu, Max = 1.15 * GameSettings.Units.SolarRadiusInAu } },
                { SpectralType.K, new MinMaxStruct() { Min = 0.7 * GameSettings.Units.SolarRadiusInAu, Max = 0.96 * GameSettings.Units.SolarRadiusInAu } },
                { SpectralType.M, new MinMaxStruct() { Min = 0.12 * GameSettings.Units.SolarRadiusInAu, Max = 0.7 * GameSettings.Units.SolarRadiusInAu} },
            };
        ...
        public static Dictionary<SpectralType, MinMaxStruct> StarTemperatureBySpectralType = new Dictionary<SpectralType, MinMaxStruct>()
            {
                { SpectralType.O, new MinMaxStruct() { Min = 30000, Max = 60000 } },
                { SpectralType.B, new MinMaxStruct() { Min = 10000, Max = 30000 } },
                { SpectralType.A, new MinMaxStruct() { Min = 7500, Max = 10000 } },
                { SpectralType.F, new MinMaxStruct() { Min = 6000, Max = 7500 } },
                { SpectralType.G, new MinMaxStruct() { Min = 5200, Max = 6000 } },
                { SpectralType.K, new MinMaxStruct() { Min = 3700, Max = 5200 } },
                { SpectralType.M, new MinMaxStruct() { Min = 2400, Max = 3700 } },
            };
        ...
        public static Dictionary<SpectralType, MinMaxStruct> StarLuminosityBySpectralType = new Dictionary<SpectralType, MinMaxStruct>()
            {
                { SpectralType.O, new MinMaxStruct() { Min = 30000, Max = 1000000 } },
                { SpectralType.B, new MinMaxStruct() { Min = 25, Max = 30000 } },
                { SpectralType.A, new MinMaxStruct() { Min = 5, Max = 25 } },
                { SpectralType.F, new MinMaxStruct() { Min = 1.5, Max = 5 } },
                { SpectralType.G, new MinMaxStruct() { Min = 0.6, Max = 1.5 } },
                { SpectralType.K, new MinMaxStruct() { Min = 0.08, Max = 0.6 } },
                { SpectralType.M, new MinMaxStruct() { Min = 0.0001, Max = 0.08 } },
            };
        ...
        public static Dictionary<SpectralType, MinMaxStruct> StarMassBySpectralType = new Dictionary<SpectralType, MinMaxStruct>()
            {
                { SpectralType.O, new MinMaxStruct() { Min = 16 * GameSettings.Units.SolarMassInKG, Max = 265 * GameSettings.Units.SolarMassInKG } },
                { SpectralType.B, new MinMaxStruct() { Min = 2.1 * GameSettings.Units.SolarMassInKG, Max = 16 * GameSettings.Units.SolarMassInKG } },
                { SpectralType.A, new MinMaxStruct() { Min = 1.4 * GameSettings.Units.SolarMassInKG, Max = 2.1 * GameSettings.Units.SolarMassInKG } },
                { SpectralType.F, new MinMaxStruct() { Min = 1.04 * GameSettings.Units.SolarMassInKG, Max = 1.4 * GameSettings.Units.SolarMassInKG } },
                { SpectralType.G, new MinMaxStruct() { Min = 0.8 * GameSettings.Units.SolarMassInKG, Max = 1.04 * GameSettings.Units.SolarMassInKG } },
                { SpectralType.K, new MinMaxStruct() { Min = 0.45 * GameSettings.Units.SolarMassInKG, Max = 0.8 * GameSettings.Units.SolarMassInKG } },
                { SpectralType.M, new MinMaxStruct() { Min = 0.08 * GameSettings.Units.SolarMassInKG, Max = 0.45 * GameSettings.Units.SolarMassInKG } },
            };
        ...
        public static Dictionary<SpectralType, MinMaxStruct> StarAgeBySpectralType = new Dictionary<SpectralType, MinMaxStruct>()
            {
                { SpectralType.O, new MinMaxStruct() { Min = 0, Max = 6000000 } },        // after 6 million years O types eiother go nova or become B type stars.
                { SpectralType.B, new MinMaxStruct() { Min = 0, Max = 100000000 } },     // could not find any info on B type ages, so i made it between O and A (100 million).
                { SpectralType.A, new MinMaxStruct() { Min = 0, Max = 350000000 } },     // A type stars are always young, typicall a few hundred million years..
                { SpectralType.F, new MinMaxStruct() { Min = 0, Max = 3000000000 } },    // Could not find any info again, chose a number between B and G stars (3 billion)
                { SpectralType.G, new MinMaxStruct() { Min = 0, Max = 10000000000 } },   // The life of a G class star is about 10 billion years.
                { SpectralType.K, new MinMaxStruct() { Min = 0, Max = 13200000000 } },
                { SpectralType.M, new MinMaxStruct() { Min = 0, Max = 13200000000 } },
            };
        ...
        public static Dictionary<BodyType, MinMaxStruct> SystemBodyMassByType = new Dictionary<BodyType, MinMaxStruct>()
            {
                { BodyType.GasGiant, new MinMaxStruct() { Min = 15 * GameSettings.Units.EarthMassInKG, Max = 500 * GameSettings.Units.EarthMassInKG } },
                { BodyType.IceGiant, new MinMaxStruct() { Min = 5 * GameSettings.Units.EarthMassInKG, Max = 30 * GameSettings.Units.EarthMassInKG} },
                { BodyType.GasDwarf, new MinMaxStruct() { Min = 1 * GameSettings.Units.EarthMassInKG, Max = 15 * GameSettings.Units.EarthMassInKG } },
                { BodyType.Terrestrial, new MinMaxStruct() { Min = 0.05 * GameSettings.Units.EarthMassInKG, Max = 5 * GameSettings.Units.EarthMassInKG }  },
                { BodyType.Moon, new MinMaxStruct() { Min = 1E16, Max = 1 * GameSettings.Units.EarthMassInKG } }, // note 1E16 is 1 nano earth mass.
                { BodyType.DwarfPlanet, new MinMaxStruct() { Min = 2E20 , Max = 5E23 } },
                { BodyType.Asteroid, new MinMaxStruct() { Min = 1E15, Max = 9E19 } },
                { BodyType.Comet, new MinMaxStruct() { Min = 1E13, Max = 9E14 } },
            };
        ...
        public static Dictionary<BodyType, MinMaxStruct> SystemBodyDensityByType = new Dictionary<BodyType, MinMaxStruct>()
            {
                { BodyType.GasGiant, new MinMaxStruct() { Min = 0.5, Max = 10 } },
                { BodyType.IceGiant, new MinMaxStruct() { Min = 1, Max = 5 } },
                { BodyType.GasDwarf, new MinMaxStruct() { Min = 1, Max = 8 } },
                { BodyType.Terrestrial, new MinMaxStruct() { Min = 3, Max = 8 } },
                { BodyType.Moon, new MinMaxStruct() { Min = 1.4, Max = 5 } },
                { BodyType.DwarfPlanet, new MinMaxStruct() { Min = 1, Max = 6 } },
                { BodyType.Asteroid, new MinMaxStruct() { Min = 1, Max = 6 } },
                { BodyType.Comet, new MinMaxStruct() { Min = 0.25, Max = 0.7 } },
            };
        ...
        public static Dictionary<SpectralType, MinMaxStruct> OrbitalDistanceByStarSpectralType = new Dictionary<SpectralType, MinMaxStruct>()
            {
                { SpectralType.O, new MinMaxStruct() { Min = 1, Max = 200 } },
                { SpectralType.B, new MinMaxStruct() { Min = 0.5, Max = 100 } },
                { SpectralType.A, new MinMaxStruct() { Min = 0.3, Max = 90 } },
                { SpectralType.F, new MinMaxStruct() { Min = 0.2, Max = 60 } },
                { SpectralType.G, new MinMaxStruct() { Min = 0.1, Max = 40 } },
                { SpectralType.K, new MinMaxStruct() { Min = 0.01, Max = 18 } },
                { SpectralType.M, new MinMaxStruct() { Min = 0.005, Max = 9 } },
            };
        ...
        public static Dictionary<BodyType, MinMaxStruct> PlanetAlbedoByType = new Dictionary<BodyType, MinMaxStruct>()
            {
                { BodyType.GasGiant, new MinMaxStruct() { Min = 0.5, Max = 0.7 } },
                { BodyType.IceGiant, new MinMaxStruct() { Min = 0.5, Max = 0.7 } },
                { BodyType.GasDwarf, new MinMaxStruct() { Min = 0.3, Max = 0.7 } },
                { BodyType.Terrestrial, new MinMaxStruct() { Min = 0.05, Max = 0.5 } },
                { BodyType.Moon, new MinMaxStruct() { Min = 0.05, Max = 0.5 } },
                { BodyType.DwarfPlanet, new MinMaxStruct() { Min = 0.05, Max = 0.95 } },
                { BodyType.Asteroid, new MinMaxStruct() { Min = 0.05, Max = 0.15 } },
                { BodyType.Comet, new MinMaxStruct() { Min = 0.95, Max = 0.99 } },
            };
        ...
        public static Dictionary<BodyType, MinMaxStruct> PlanetMagneticFieldByType = new Dictionary<BodyType, MinMaxStruct>()
            {
                { BodyType.GasGiant, new MinMaxStruct() { Min = 10, Max = 2000 } },
                { BodyType.IceGiant, new MinMaxStruct() { Min = 5, Max = 50 } },
                { BodyType.GasDwarf, new MinMaxStruct() { Min = 0.1, Max = 20 } },
                { BodyType.Terrestrial, new MinMaxStruct() { Min = 0.0001, Max = 45 } },
                { BodyType.Moon, new MinMaxStruct() { Min = 0.0001, Max = 1 } },
                { BodyType.DwarfPlanet, new MinMaxStruct() { Min = 0.00001, Max = 0.0001 } },
                { BodyType.Asteroid, new MinMaxStruct() { Min = 0.000001, Max = 0.00001 } },
                { BodyType.Comet, new MinMaxStruct() { Min = 0.0000001, Max = 0.000001 } },
            };
        ...
        public static Dictionary<SystemBand, double> BandBodyWeight = new Dictionary<SystemBand,double>()
        {
            { SystemBand.InnerBand, 0.3 },
            { SystemBand.HabitableBand, 0.1},
            { SystemBand.OuterBand, 0.6},
        };
        ...
        {
            { Ruins.RSize.Outpost, new MinMaxStruct() { Min = 15, Max = 50 } },
            { Ruins.RSize.Settlement, new MinMaxStruct() { Min = 50, Max = 100 } },
            { Ruins.RSize.Colony, new MinMaxStruct() { Min = 100, Max = 200 } },
            { Ruins.RSize.City, new MinMaxStruct() { Min = 500, Max = 1000 } },
        };
